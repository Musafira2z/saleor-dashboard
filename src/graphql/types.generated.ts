...
export type HomeQueryVariables = Exact<{
  ...
  PERMISSION_MANAGE_ORDERS: Scalars['Boolean'];
  firstTopProducts?: InputMaybe<Scalars['Int']>;
  lastTopProducts?: InputMaybe<Scalars['Int']>;
  beforeTopProducts?: InputMaybe<Scalars['String']>;
  afterTopProducts?: InputMaybe<Scalars['String']>;
  firstActivities?: InputMaybe<Scalars['Int']>;
  lastActivities?: InputMaybe<Scalars['Int']>;
  beforeActivities?: InputMaybe<Scalars['String']>;
  afterActivities?: InputMaybe<Scalars['String']>;
}>;


export type HomeQuery = { __typename: 'Query', salesPeriod: { __typename: 'TaxedMoney', gross: { __typename: 'Money', amount: number, currency: string } } | null, ordersToday: { __typename: 'OrderCountableConnection', totalCount: number | null } | null, ordersToFulfill: { __typename: 'OrderCountableConnection', totalCount: number | null } | null, ordersToCapture: { __typename: 'OrderCountableConnection', totalCount: number | null } | null, ordersToUnconfirmed: { __typename: 'OrderCountableConnection', totalCount: number | null } | null, ordersToUnfulfilled: { __typename: 'OrderCountableConnection', totalCount: number | null } | null, productsOutOfStock: { __typename: 'ProductCountableConnection', totalCount: number | null } | null, topProducts: { __typename: 'ProductVariantCountableConnection', edges: Array<{ __typename: 'ProductVariantCountableEdge', node: { __typename: 'ProductVariant', id: string, quantityAvailable: number | null, quantityOrdered: number | null, revenue: { __typename: 'TaxedMoney', gross: { __typename: 'Money', amount: number, currency: string } } | null, attributes: Array<{ __typename: 'SelectedAttribute', values: Array<{ __typename: 'AttributeValue', id: string, name: string | null }> }>, product: { __typename: 'Product', id: string, name: string, thumbnail: { __typename: 'Image', url: string } | null }, stocks: Array<{ __typename: 'Stock', quantity: number, productVariant: { __typename: 'ProductVariant', name: string } }> | null } }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } | null, activities: { __typename: 'OrderEventCountableConnection', edges: Array<{ __typename: 'OrderEventCountableEdge', node: { __typename: 'OrderEvent', amount: number | null, composedId: string | null, date: any | null, email: string | null, emailType: OrderEventsEmailsEnum | null, id: string, message: string | null, orderNumber: string | null, oversoldItems: Array<string> | null, quantity: number | null, type: OrderEventsEnum | null, user: { __typename: 'User', id: string, email: string } | null } }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } | null };
